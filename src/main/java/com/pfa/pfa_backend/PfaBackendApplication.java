...
public class PfaBackendApplication {
    ...
    CommandLineRunner start(@Autowired MunicipalRepository mr,@Autowired ResponsableGeneralRepository rgr) {
        return args -> {
            ...
            ResponsableGeneral rg1 = new ResponsableGeneral("12846030","موسى","نور",new Date(98, 12, 5),"سوسة","أنثى","37 نهج البشير صفر 4070 مساكن","25728023","moussanouralhouda@gmail.com",new BCryptPasswordEncoder().encode("12345"),m3);
